...
#SBATCH --gres=gpu:1             
#SBATCH --output=/vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/multiruns_slurm_scripts/multiruns_slurm_logs/chexmod_fft/%x.%N.%j.log  
#SBATCH --time=0-05:00:00        

# Accepts multirun_id from the command line; --job-name replaces the %x in --output above
#SBATCH --job-name=chexmod_fft_multirun
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CheXpert_model__full_finetuning.py --multirun_id "$1"

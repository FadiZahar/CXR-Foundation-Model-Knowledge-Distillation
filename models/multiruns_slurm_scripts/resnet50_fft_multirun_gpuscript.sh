...
#SBATCH --job-name=resnet50_fft_"$1"
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__ResNet50__full_finetuning.py --multirun_id "$1"

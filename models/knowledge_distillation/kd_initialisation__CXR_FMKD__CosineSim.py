...
DEV_SPLIT = [0.7, 0.3]
EPOCHS = 40
pre_OUT_DIR_NAME = 'CXR-FMKD_KD-initialisation-CosineSim/'
...
class Pre_CXR_FMKD(LightningModule):
    ...
    def process_batch(self, batch):
        ...
        # Calculate cosine similarity between output embeddings and target embeddings
...
def main(hparams):
    ...
    trainer = Trainer(
        ...
        callbacks=[ModelCheckpoint(monitor='val_loss', 
                                   mode='min', 
                                   filename='best-checkpoint_pre-CXR-FMKD_CosineSim_{epoch}-{val_loss:.4f}',

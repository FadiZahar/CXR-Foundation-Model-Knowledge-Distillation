...
#SBATCH --job-name=cxrfmkd_kdinit_cosinesim_"$1"
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/knowledge_distillation/kd_initialisation__CXR_FMKD__CosineSim.py --multirun_id "$1"

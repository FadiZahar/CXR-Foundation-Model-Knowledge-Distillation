...
DEV_SPLIT = [0.7, 0.3]
EPOCHS = 40
pre_OUT_DIR_NAME = 'CXR-FMKD_KD-initialisation-CustomNormKL/'
...
class Pre_CXR_FMKD(LightningModule):
    ...
    def process_batch(self, batch):
        ...
        loss = self.custom_kl_loss(output_embeds, target_embeds)
        return loss
...
def main(hparams):
    ...
    KD_TYPE_DIR_NAME = "KD-CustomNormKL"
    ...
    trainer = Trainer(
        ...
        callbacks=[ModelCheckpoint(monitor='val_loss', 
                                   mode='min', 
                                   filename='best-checkpoint_pre-CXR-FMKD_CustomNormKL_{epoch}-{val_loss:.4f}',

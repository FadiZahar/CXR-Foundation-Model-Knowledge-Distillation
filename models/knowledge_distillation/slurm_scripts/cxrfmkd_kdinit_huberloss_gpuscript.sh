...
#SBATCH --job-name=cxrfmkd_kdinit_huberloss
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/knowledge_distillation/kd_initialisation__CXR_FMKD__HuberLoss.py --config "$1"

...
#SBATCH --gres=gpu:1             
#SBATCH --output=/vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/knowledge_distillation/slurm_scripts/slurm_logs/cxrfmkd_kdinit_cosinesim.%N.%j.log  
#SBATCH --time=1-00:00:00        

#SBATCH --job-name=cxrfmkd_kdinit_cosinesim
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/knowledge_distillation/kd_initialisation__CXR_FMKD__CosineSim.py

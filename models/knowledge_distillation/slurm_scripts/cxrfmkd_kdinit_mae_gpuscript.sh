...
#SBATCH --job-name=cxrfmkd_kdinit_mae
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/knowledge_distillation/kd_initialisation__CXR_FMKD__MAE.py --config "$1"

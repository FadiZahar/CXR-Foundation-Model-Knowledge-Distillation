...
#SBATCH --job-name=cxrfmkd_lp_mse&cosinesimweighted_alpha0p50
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD__linear_probing.py --kd_type 'MSEandCosineSimWeighted-alpha0p50' --config "$1"

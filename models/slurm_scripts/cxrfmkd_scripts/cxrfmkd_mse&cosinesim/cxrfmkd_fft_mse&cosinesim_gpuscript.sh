...
#SBATCH --job-name=cxrfmkd_fft_mse&cosinesim
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD__full_finetuning.py --kd_type 'MSEandCosineSim' --config "$1"

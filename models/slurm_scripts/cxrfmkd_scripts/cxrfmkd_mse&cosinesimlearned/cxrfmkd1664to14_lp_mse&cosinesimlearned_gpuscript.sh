...
#SBATCH --job-name=cxrfmkd1664to14_lp_mse&cosinesimlearned
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD_1664to14__linear_probing.py --kd_type 'MSEandCosineSimLearned' --config "$1"

...
#SBATCH --gres=gpu:1             
#SBATCH --output=/vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/slurm_scripts/slurm_logs/cxrfmkd_fft_mse&cosinesimweighted.%N.%j.log  
#SBATCH --time=0-05:00:00        

#SBATCH --job-name=cxrfmkd_fft_mse&cosinesimweighted
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD__full_finetuning.py --kd_type 'MSEandCosineSimWeighted'

...
#SBATCH --gres=gpu:1             
#SBATCH --output=/vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/slurm_scripts/slurm_logs/cxrfmkd/cxrfmkd_huberloss/%x.%N.%j.log  
#SBATCH --time=0-05:00:00
#SBATCH --nodelist=luna 

#SBATCH --job-name=cxrfmkd1664to14_fft_huberloss
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD_1664to14__full_finetuning.py --kd_type 'HuberLoss' --config "$1"

...
#SBATCH --job-name=cxrfmkd_lp_huberloss
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD__linear_probing.py --kd_type 'HuberLoss' --config "$1"

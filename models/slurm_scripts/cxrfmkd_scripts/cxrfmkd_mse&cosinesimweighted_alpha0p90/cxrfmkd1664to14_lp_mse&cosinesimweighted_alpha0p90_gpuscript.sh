...
#SBATCH --job-name=cxrfmkd1664to14_lp_mse&cosinesimweighted_alpha0p90
...
python /vol/biomedic3/bglocker/mscproj24/fz221/cxr-fmkd/models/disease_prediction__CXR_FMKD_1664to14__linear_probing.py --kd_type 'MSEandCosineSimWeighted-alpha0p90' --config "$1"

...
def main(hparams):
    ...
    # From model config:
    BEST_CHECKPOINT_PATH = model_config.BEST_CHECKPOINT__CXR_FMKD_linear_probing__FILENAME
    ...
    # Model
    model = CXR_FMKD_LinearProbing.load_from_checkpoint(BEST_CHECKPOINT_PATH, num_classes=NUM_CLASSES, learning_rate=LEARNING_RATE,
    ...
    trainer = Trainer(
        ...
        callbacks=[ModelCheckpoint(monitor='val_loss', 
                                   mode='min', 
                                   filename='best-checkpoint_zsinfer_CXR-FMKD_lp_{epoch}-{val_loss:.4f}',

...
# Model import
from models.disease_prediction__CXR_FM__linear_probing import CXR_FM

pre_OUT_DIR_NAME = 'CXR-FM_linear-probing/'
...
def main(hparams):
    ...
    BEST_CHECKPOINT_FILEPATH = model_config.BEST_CHECKPOINT__CXR_FM_linear_probing__FILEPATH
    ...
    # Trained Model
    model = CXR_FM.load_from_checkpoint(BEST_CHECKPOINT_FULLPATH, num_classes=NUM_CLASSES, learning_rate=LEARNING_RATE, 
    ...
    trainer = Trainer(
        ...
        callbacks=[ModelCheckpoint(monitor='val_loss', 
                                   mode='min', 
                                   filename='best-checkpoint_zsinfer_CXR-FM_lp_{epoch}-{val_loss:.4f}',

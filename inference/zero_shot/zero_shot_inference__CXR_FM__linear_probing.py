...
def main(hparams):
    ...
    # From model config:
    BEST_CHECKPOINT_PATH = model_config.BEST_CHECKPOINT__CXR_FM_linear_probing__FILENAME
    ...
    # Trained Model
    model = CXR_FM.load_from_checkpoint(BEST_CHECKPOINT_PATH, num_classes=NUM_CLASSES, learning_rate=LEARNING_RATE, 
